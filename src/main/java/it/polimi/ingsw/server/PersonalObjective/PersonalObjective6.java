...
public class PersonalObjective6 extends PersonalObjective{
    ...
    static{
        ...
        card.put(new Point(5,0), Tiles.PINK);
        card.put(new Point(4,3), Tiles.BLUE);
        card.put(new Point(0,4), Tiles.GREEN);
        card.put(new Point(2,3), Tiles.WHITE);
        card.put(new Point(4,1), Tiles.YELLOW);
        card.put(new Point(0,2), Tiles.LIGHT_BLUE);
    }
