...
public class PersonalObjective4 extends PersonalObjective{
    ...
    static{
        card.put(new Point(3,3), Tiles.PINK);
        card.put(new Point(2,2), Tiles.BLUE);
        card.put(new Point(4,2), Tiles.GREEN);
        card.put(new Point(4,1), Tiles.WHITE);
        card.put(new Point(0,4), Tiles.YELLOW);
        card.put(new Point(2,0), Tiles.LIGHT_BLUE);
    }
