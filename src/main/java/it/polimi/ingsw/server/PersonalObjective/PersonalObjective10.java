...
public class PersonalObjective10 extends PersonalObjective{
    ...
    static{
        card.put(new Point(5,3), Tiles.PINK);
        card.put(new Point(4,1), Tiles.BLUE);
        card.put(new Point(3,3), Tiles.GREEN);
        card.put(new Point(2,0), Tiles.WHITE);
        card.put(new Point(1,1), Tiles.YELLOW);
        card.put(new Point(0,4), Tiles.LIGHT_BLUE);
    }
