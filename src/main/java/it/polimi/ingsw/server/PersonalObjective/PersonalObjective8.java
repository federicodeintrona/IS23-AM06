...
public class PersonalObjective8 extends PersonalObjective{
    ...
    static{
        ...
        card.put(new Point(3,0), Tiles.PINK);
        card.put(new Point(0,4), Tiles.BLUE);
        card.put(new Point(1,1), Tiles.GREEN);
        card.put(new Point(4,3), Tiles.WHITE);
        card.put(new Point(5,3), Tiles.YELLOW);
        card.put(new Point(2,2), Tiles.LIGHT_BLUE);
    }
