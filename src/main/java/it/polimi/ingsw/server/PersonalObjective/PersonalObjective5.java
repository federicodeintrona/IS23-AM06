...
public class PersonalObjective5 extends PersonalObjective{
    ...
    static{
        ...
        card.put(new Point(3,1), Tiles.BLUE);
        card.put(new Point(5,3), Tiles.GREEN);
        card.put(new Point(3,2), Tiles.WHITE);
        card.put(new Point(5,0), Tiles.YELLOW);
        card.put(new Point(1,1), Tiles.LIGHT_BLUE);
    }
