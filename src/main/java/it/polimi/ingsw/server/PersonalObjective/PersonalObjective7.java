...
public class PersonalObjective7 extends PersonalObjective{
    ...
    static{
        card.put(new Point(2,1), Tiles.PINK);
        card.put(new Point(1,3), Tiles.BLUE);
        card.put(new Point(0,0), Tiles.GREEN);
        card.put(new Point(5,2), Tiles.WHITE);
        card.put(new Point(4,4), Tiles.YELLOW);
        card.put(new Point(3,0), Tiles.LIGHT_BLUE);
    }
