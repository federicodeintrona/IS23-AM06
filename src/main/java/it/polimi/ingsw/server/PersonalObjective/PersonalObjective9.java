...
public class PersonalObjective9 extends PersonalObjective{

    private static final HashMap<Point, Tiles> card=new HashMap<>();

    static{
        //creazione PersonalObjective
        card.put(new Point(4,4), Tiles.PINK);
        card.put(new Point(5,0), Tiles.BLUE);
        card.put(new Point(2,2), Tiles.GREEN);
        card.put(new Point(3,4), Tiles.WHITE);
        card.put(new Point(0,2), Tiles.YELLOW);
        card.put(new Point(4,1), Tiles.LIGHT_BLUE);
    }
