...
public class PersonalObjective11 extends PersonalObjective{

    private static final HashMap<Point, Tiles> card=new HashMap<>();

    static{
        //creazione PersonalObjective
        card.put(new Point(0,2), Tiles.PINK);
        card.put(new Point(3,2), Tiles.BLUE);
        card.put(new Point(4,4), Tiles.GREEN);
        card.put(new Point(1,1), Tiles.WHITE);
        card.put(new Point(2,0), Tiles.YELLOW);
        card.put(new Point(5,3), Tiles.LIGHT_BLUE);
    }
