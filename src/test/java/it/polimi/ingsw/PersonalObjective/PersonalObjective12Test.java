...
import it.polimi.ingsw.server.PersonalObjective.PersonalObjective12;
...
class PersonalObjective12Test {
    ...
    void checkCondition1() {
        ...
        PersonalObjective12 po=new PersonalObjective12();
        ...
        player.getBookshelf().getTiles().setTile(Tiles.LIGHT_BLUE, 3,3);
