...
import it.polimi.ingsw.server.PersonalObjective.PersonalObjective5;
...
class PersonalObjective5Test {
    ...
    void checkCondition1() {
        ...
        PersonalObjective5 po=new PersonalObjective5();
        ...
        player.getBookshelf().getTiles().setTile(Tiles.LIGHT_BLUE, 1,1);
        ...
        player.getBookshelf().getTiles().setTile(Tiles.YELLOW, 5,0);
